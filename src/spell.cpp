...
cSpell M_SPARK = cSpell(eSpell::SPARK).asType(eSkill::MAGE_SPELLS).asLevel(1)
	.withRange(6).withTargetLock().withCost(1).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_SCARE = cSpell(eSpell::SCARE).asType(eSkill::MAGE_SPELLS).asLevel(1)
	.withRange(7).withTargetLock().withCost(1).withRefer(REFER_TARGET).when(WHEN_COMBAT).asPeaceful().finish();
cSpell M_CLOUD_FLAME = cSpell(eSpell::CLOUD_FLAME).asType(eSkill::MAGE_SPELLS).asLevel(1)
	.withRange(7).withTargetLock().withCost(2).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_SCRY_MONSTER = cSpell(eSpell::SCRY_MONSTER).asType(eSkill::MAGE_SPELLS).asLevel(1)
	.withRange(14).withTargetLock().withCost(2).withRefer(REFER_TARGET).when(WHEN_COMBAT).when(WHEN_TOWN).asPeaceful().finish();
cSpell M_GOO = cSpell(eSpell::GOO).asType(eSkill::MAGE_SPELLS).asLevel(1)
	.withRange(8).withTargetLock().withCost(1).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_POISON_MINOR = cSpell(eSpell::POISON_MINOR).asType(eSkill::MAGE_SPELLS).asLevel(2)
	.withRange(6).withTargetLock().withCost(2).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
cSpell M_FLAME = cSpell(eSpell::FLAME).asType(eSkill::MAGE_SPELLS).asLevel(2)
	.withRange(8).withTargetLock().withCost(3).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_DUMBFOUND = cSpell(eSpell::DUMBFOUND).asType(eSkill::MAGE_SPELLS).asLevel(2)
	.withRange(10).withTargetLock().withCost(2).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_CLOUD_STINK = cSpell(eSpell::CLOUD_STINK).asType(eSkill::MAGE_SPELLS).asLevel(2)
	.withRange(8).withTargetLock().withCost(2).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_CONFLAGRATION = cSpell(eSpell::CONFLAGRATION).asType(eSkill::MAGE_SPELLS).asLevel(2)
	.withRange(8).withTargetLock().withCost(4).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_CLOUD_SLEEP = cSpell(eSpell::CLOUD_SLEEP).asType(eSkill::MAGE_SPELLS).asLevel(2)
	.withRange(6).withTargetLock().withCost(6).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_FIREBALL = cSpell(eSpell::FIREBALL).asType(eSkill::MAGE_SPELLS).asLevel(3)
	.withRange(12).withTargetLock().withCost(5).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_FEAR = cSpell(eSpell::FEAR).asType(eSkill::MAGE_SPELLS).asLevel(3)
	.withRange(10).withTargetLock().withCost(3).withRefer(REFER_TARGET).when(WHEN_COMBAT).asPeaceful().finish();
...
cSpell M_ARROWS_FLAME = cSpell(eSpell::ARROWS_FLAME).asType(eSkill::MAGE_SPELLS).asLevel(3)
	.withRange(10).withTargetLock().withCost(4).withRefer(REFER_FANCY).when(WHEN_COMBAT).finish();
cSpell M_WEB = cSpell(eSpell::WEB).asType(eSkill::MAGE_SPELLS).asLevel(3)
	.withRange(8).withTargetLock().withCost(6).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_CAPTURE_SOUL = cSpell(eSpell::CAPTURE_SOUL).asType(eSkill::MAGE_SPELLS).asLevel(4)
	.withRange(10).withTargetLock().withCost(30).withRefer(REFER_TARGET).when(WHEN_COMBAT).when(WHEN_TOWN).finish();
...
cSpell M_ARROWS_VENOM = cSpell(eSpell::ARROWS_VENOM).asType(eSkill::MAGE_SPELLS).asLevel(4)
	.withRange(8).withTargetLock().withCost(8).withRefer(REFER_FANCY).when(WHEN_COMBAT).finish();
...
cSpell M_FIRESTORM = cSpell(eSpell::FIRESTORM).asType(eSkill::MAGE_SPELLS).asLevel(5)
	.withRange(14).withTargetLock().withCost(8).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_BARRIER_FIRE = cSpell(eSpell::BARRIER_FIRE).asType(eSkill::MAGE_SPELLS).asLevel(5)
	.withRange(2).withTargetLock().withCost(9).withRefer(REFER_TARGET).when(WHEN_TOWN).when(WHEN_COMBAT).finish();
...
cSpell M_SHOCKSTORM = cSpell(eSpell::SHOCKSTORM).asType(eSkill::MAGE_SPELLS).asLevel(5)
	.withRange(10).withTargetLock().withCost(6).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
cSpell M_SPRAY_FIELDS = cSpell(eSpell::SPRAY_FIELDS).asType(eSkill::MAGE_SPELLS).asLevel(5)
	.withRange(12).withTargetLock().withCost(6).withRefer(REFER_FANCY).when(WHEN_COMBAT).finish();

cSpell M_POISON_MAJOR = cSpell(eSpell::POISON_MAJOR).asType(eSkill::MAGE_SPELLS).asLevel(6)
	.withRange(8).withTargetLock().withCost(7).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
// This is always centered on the caster:
...
cSpell M_KILL = cSpell(eSpell::KILL).asType(eSkill::MAGE_SPELLS).asLevel(6)
	.withRange(6).withTargetLock().withCost(8).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
cSpell M_PARALYZE = cSpell(eSpell::PARALYZE).asType(eSkill::MAGE_SPELLS).asLevel(6)
	.withRange(8).withTargetLock().withCost(7).withRefer(REFER_FANCY).when(WHEN_COMBAT).finish();
...
cSpell M_ANTIMAGIC = cSpell(eSpell::ANTIMAGIC).asType(eSkill::MAGE_SPELLS).asLevel(6)
	.withRange(8).withTargetLock().withCost(10).withRefer(REFER_TARGET).when(WHEN_COMBAT).when(WHEN_TOWN).finish();
cSpell M_MINDDUEL = cSpell(eSpell::MINDDUEL).asType(eSkill::MAGE_SPELLS).asLevel(6)
	.withRange(40).withTargetLock().withCost(12).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell M_BARRIER_FORCE = cSpell(eSpell::BARRIER_FORCE).asType(eSkill::MAGE_SPELLS).asLevel(7)
	.withRange(2).withTargetLock().withCost(10).withRefer(REFER_TARGET).when(WHEN_COMBAT).when(WHEN_TOWN).asPeaceful().finish();
cSpell M_QUICKFIRE = cSpell(eSpell::QUICKFIRE).asType(eSkill::MAGE_SPELLS).asLevel(7)
	.withRange(4).withTargetLock().withCost(50).withRefer(REFER_TARGET).when(WHEN_COMBAT).when(WHEN_TOWN).finish();
cSpell M_ARROWS_DEATH = cSpell(eSpell::ARROWS_DEATH).asType(eSkill::MAGE_SPELLS).asLevel(7)
	.withRange(6).withTargetLock().withCost(10).withRefer(REFER_FANCY).when(WHEN_COMBAT).finish();
...
cSpell P_STUMBLE = cSpell(eSpell::STUMBLE).asType(eSkill::PRIEST_SPELLS).asLevel(1)
	.withRange(10).withTargetLock().withCost(1).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell P_WOUND = cSpell(eSpell::WOUND).asType(eSkill::PRIEST_SPELLS).asLevel(2)
	.withRange(6).withTargetLock().withCost(3).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell P_DISEASE = cSpell(eSpell::DISEASE).asType(eSkill::PRIEST_SPELLS).asLevel(2)
	.withRange(6).withTargetLock().withCost(4).withRefer(REFER_FANCY).when(WHEN_COMBAT).finish();
...
cSpell P_FORCEFIELD = cSpell(eSpell::FORCEFIELD).asType(eSkill::PRIEST_SPELLS).asLevel(3)
	.withRange(8).withTargetLock().withCost(5).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell P_SMITE = cSpell(eSpell::SMITE).asType(eSkill::PRIEST_SPELLS).asLevel(3)
	.withRange(8).withTargetLock().withCost(6).withRefer(REFER_FANCY).when(WHEN_COMBAT).finish();
...
cSpell P_WALL_BLADES = cSpell(eSpell::WALL_BLADES).asType(eSkill::PRIEST_SPELLS).asLevel(7)
	.withRange(10).withTargetLock().withCost(12).withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell S_WALL_ICE_BALL = cSpell(eSpell::WALL_ICE_BALL)
	.withRange(8).withTargetLock().withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
cSpell S_GOO_BOMB = cSpell(eSpell::GOO_BOMB)
	.withRange(12).withTargetLock().withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
cSpell S_FOUL_VAPOR = cSpell(eSpell::FOUL_VAPOR)
	.withRange(8).withTargetLock().withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
cSpell S_CLOUD_SLEEP_LARGE = cSpell(eSpell::CLOUD_SLEEP_LARGE)
	.withRange(10).withTargetLock().withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
...
cSpell S_WRACK = cSpell(eSpell::WRACK).asLevel(1)
	.withRange(6).withTargetLock().withRefer(REFER_TARGET).when(WHEN_COMBAT).finish();
