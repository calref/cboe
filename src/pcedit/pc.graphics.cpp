...
void draw_main_screen() {
	...
	auto const &icon_gworld = *ResMgr::graphics.get("icon");
	...
	auto const &title_gworld = *ResMgr::graphics.get("pcedtitle");
...
void display_party() {
	...
	if(file_in_mem.empty()) { // what if no party loaded?
		...
		auto const &buttons_gworld = *ResMgr::graphics.get("pcedbuttons");
