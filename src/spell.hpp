...
enum class eSpell {
	...
	SIMULACRUM = 35, ARROWS_VENOM = 36, WALL_ICE = 37, /* Page 2 */ STEALTH = 38, HASTE_MAJOR = 39,
	...
	MARTYRS_SHIELD = 135, CLEANSE = 136, FIREWALK = 137, /* Page 2 */ BLESS_PARTY = 138, HEAL_MAJOR = 139,
